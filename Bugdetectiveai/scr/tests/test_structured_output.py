...
from structured_output.output_processor import (
...
class TestStructuredOutputProcessor(unittest.TestCase):
    ...
    def test_process_output_failed_generation(self):
        ...
        output = StructuredOutput(
            success=False, content={}, error_message="API rate limit exceeded"
        )
    ...
    def test_extract_key_fields(self):
        ...
        expected = {"bug_type": "syntax_error", "severity": "high", "confidence": 0.9}
    ...
    def test_extract_key_fields_missing_fields(self):
        ...
        expected = {"bug_type": "syntax_error", "severity": "high"}
        self.assertEqual(extracted, expected)
