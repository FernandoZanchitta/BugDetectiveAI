...
def load_stable_dataset(split: str = 'test', base_path: Optional[str] = None) -> pd.DataFrame:
    """
...
def filter_dataset_by_length(df: pd.DataFrame, 
                           column: str = 'before_merge', 
                           max_length: int = 900) -> pd.DataFrame:
    """
